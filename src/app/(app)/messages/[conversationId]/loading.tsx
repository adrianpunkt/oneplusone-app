  ...
  return (
    ...
    >
      ...
      <div className="mx-auto flex h-full w-full max-w-6xl flex-col gap-0 md:gap-2">
        ...
        <div className="min-h-0 flex-1 overflow-hidden rounded-none border border-wine-burgundy/10 bg-white md:rounded-lg">
          <div className="h-full min-h-0 overflow-hidden bg-blush-pink p-3">
            <div className="grid gap-3">
              <Skeleton className="h-20 w-4/5 bg-white" />
              <Skeleton className="ml-auto h-20 w-3/4 bg-lipstick-red/12" />
              <Skeleton className="h-20 w-2/3 bg-white" />
              <Skeleton className="ml-auto h-20 w-4/5 bg-lipstick-red/12" />
            </div>
          </div>
        </div>
      </div>
