...
const stepClassName =
  "grid w-full grid-cols-[auto_minmax(0,1fr)] items-center gap-3 rounded-lg border border-wine-burgundy/10 bg-white p-4 text-left shadow-sm transition duration-150 hover:-translate-y-0.5 hover:border-lipstick-red/25 hover:bg-blush-pink hover:shadow-[0_18px_45px_rgba(68,10,18,0.09)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-lipstick-red/30 focus-visible:ring-offset-2";
  ...
  return (
    <>
      ...
      <span className="grid gap-1">
        <span className="text-lg font-extrabold leading-6 text-wine-burgundy">
          {step.title}
        </span>
  ...
  return (
    <Dialog.Root open={isOpen} onOpenChange={setIsOpen}>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed left-1/2 top-1/2 z-50 grid w-[min(calc(100vw-2rem),30rem)] max-h-[calc(100dvh-2rem)] -translate-x-1/2 -translate-y-1/2 gap-5 overflow-y-auto rounded-lg border border-wine-burgundy/10 bg-white p-5 shadow-2xl">
