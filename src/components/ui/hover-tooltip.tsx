...
const placementClasses = {
  ...
  "top-right": "bottom-full right-0 mb-2 before:-bottom-1 before:right-4",
  "top-center":
...
export function HoverTooltip({
  ...
  return (
    <span
      aria-hidden="true"
      className={cn(
        "pointer-events-none absolute z-50 w-max max-w-[calc(100vw-1rem)] whitespace-normal rounded-md border border-lipstick-red/20 bg-lipstick-red px-2.5 py-1.5 text-xs font-semibold leading-4 text-white opacity-0 shadow-lg shadow-lipstick-red/20 ring-1 ring-white/20 translate-y-1 transition-[opacity,transform] duration-150 before:absolute before:h-2 before:w-2 before:rotate-45 before:bg-lipstick-red before:content-[''] group-hover:translate-y-0 group-hover:opacity-100 group-focus-visible:translate-y-0 group-focus-visible:opacity-100 group-focus-within:translate-y-0 group-focus-within:opacity-100",
